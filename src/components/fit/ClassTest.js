...
export class ClassTest extends React.Component {
	...
	componentDidUpdate(prevProps, prevState, snapshot) {
		console.log('classTest did update', this.props, this.state, prevProps, prevState, snapshot);
	}
	...
	shouldComponentUpdate(nextProps, nextState) {
		console.log('classTest shouldComponentUpdate', this.props, this.state, nextProps, nextState);
		return true;
	}
	getSnapshotBeforeUpdate(prevProp, prevState) {
		console.log('classTest getSnapshotBeforeUpdate', this.props, this.state, prevProp, prevState);
		return {
			snap: 1
		};
	}
